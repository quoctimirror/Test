...
const MirrorExp = () => {
  ...
  useEffect(() => {
    if (mirrorExpRef.current) {
      ...
      console.log('Center X:', centerX + 'px (chấm đỏ)');
      console.log('Center Y:', centerY + 'px (chấm đỏ)');
      console.log('Layer0 (layer0.png) Radius:', layer0Radius + 'px - z:6 - nhỏ nhất, trước cùng - thuận chiều 8s');
      console.log('Layer1 (layer1.png) Radius:', layer1Radius + 'px - z:5 - ngược chiều 8.8s');
      console.log('Layer2 (layer2.png) Radius:', layer2Radius + 'px - z:4 - thuận chiều 9.6s');
      console.log('Layer3 (layer3.png) Radius:', layer3Radius + 'px - z:3 - ngược chiều 10.4s');
      console.log('Layer4 (layer4.png) Radius:', layer4Radius + 'px - z:2 - thuận chiều 11.2s');
      console.log('Layer5 (layer5.png) Radius:', layer5Radius + 'px - z:1 - lớn nhất, sau cùng - ngược chiều 12s');
      console.log('======================');
    }
  }, []);
