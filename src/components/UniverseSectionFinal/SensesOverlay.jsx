...
const SensesOverlay = ({ isActive, overlayStyle, onClose }) => {
    ...
    const senseData = {
        sight: "The dance of light through faceted stones, the glow of Viva Magenta reflecting off mirrored surfaces. Each display is a painting. Each showroom, a moving gallery",
        touch: "The weight of gold, the chill of glass, the softness of velvet beneath your fingers. Every texture, a whisper of refinement.",
        scent: "Our signature fragrance lingers in the air. A memory waiting to be written. Candles, co-creations, and collaborations - designed to be felt through breath.",
        sound: "Curated melodies. Ambient echoes that ground you in the now. The hum of craftsmanship, the pulse of elegance.",
        taste: "Not in food, but in aftertaste. The lingering feeling of a moment made beautiful."
    };
